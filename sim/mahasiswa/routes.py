...
@vmahasiswa.route("/edit_mahasiswa", methods=['GET', 'POST'])
@login_required
def edit_mahasiswa():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('vmahasiswa.edit_mahasiswa'))
...
def pengaduan():
    ...
    if form.validate_on_submit():
        ...
        add_pengaduan = Tpengaduan(subjek=form.subjek.data, katagori=form.katagori.data, detail_pengaduan=form.detail_pengaduan.data, mahasiswa=current_user)
